...
You can also include a `weight` column in df_edges. The weights column will be normalized within each triangle as w = w/sum(w) for that particular triangle. Edges with larger weights will be adjusted proportionally less than edges with smaller weights. 
