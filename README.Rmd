...
```{r example_valid, figures-side, fig.show="hold", out.width="50%"}
...
```{r example_invalid, figures-side, fig.show="hold", out.width="50%"}
df_edges <-
  tidyr::tribble(
    ~node1, ~node2, ~edge,
    "a", "b", 1,
...
```{r example_with_square, figures-side, fig.show="hold", out.width="50%"}
df_edges <-
  tidyr::tribble(
    ~node1, ~node2, ~edge,
    "a", "b", 1,
...
```{r example_complex, figures-side, fig.show="hold", out.width="50%"}
...
```{r example_weights, figures-side, fig.show="hold", out.width="50%"}
df_edges <-
  tidyr::tribble(
